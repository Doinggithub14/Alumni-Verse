        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <div className="bg-gray-900 p-6 rounded-xl shadow-md">
            <h3 className="text-xl font-bold text-purple-300">
              Global Alumni Meetup
            </h3>
            <p className="text-sm text-gray-400 mt-2">
              📍 New York | 🗓️ June 20, 2025
            </p>
            <p className="mt-3 text-gray-300 text-sm">
              Reunite with old friends, make new connections, and celebrate
          ...
          <div className="bg-gray-900 p-6 rounded-xl shadow-md">
            ...
            <p className="text-sm text-gray-400 mt-2">
              📍 San Francisco | 🗓️ July 15, 2025
            </p>
            <p className="mt-3 text-gray-300 text-sm">
              Join alumni working in tech to share knowledge, startups, and
              ideas.
            </p>
          </div>
          <div className="bg-gray-900 p-6 rounded-xl shadow-md">
            ...
            <p className="text-sm text-gray-400 mt-2">
              📍 Virtual | 🗓️ August 10, 2025
            </p>
            <p className="mt-3 text-gray-300 text-sm">
              Polish your resume, get interview tips, and access insider job
              referrals.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <div className="bg-gray-900 p-5 rounded-xl">
            ...
            <p className="mt-2 text-sm text-gray-300">
              Work with top tech teams to build scalable apps.
            </p>
          </div>
          <div className="bg-gray-900 p-5 rounded-xl">
            <h3 className="text-lg font-bold text-purple-300">
            ...
            <p className="mt-2 text-sm text-gray-300">
              Create intuitive user experiences for millions.
            </p>
          </div>
          <div className="bg-gray-900 p-5 rounded-xl">
            <h3 className="text-lg font-bold text-purple-300">
            ...
            <p className="mt-2 text-sm text-gray-300">
              Join cutting-edge AI projects and research teams.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-black to-purple-950 text-white py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-purple-300 mb-4">
            💬 Join the Alumni Chat Forum
          </h2>
          <p className="text-neutral-300 mb-6">
            Connect with fellow graduates, ask questions, share stories, or get
            career advice in real-time.
          </p>
      ...
      <section className="bg-black text-white py-16 px-6 border-t border-purple-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300">
            Whether you are looking for guidance or eager to give back—our
            mentorship platform will help students and alumni connect
            meaningfully.
          </p>
